...
googleButton = Button(constants.root, text = "Google", command = lambda: openWebsite("https://www.google.com/")) 
canvasButton = Button(constants.root, text = "Canvas", command = lambda: openWebsite("https://hse.instructure.com/")) 
...
cleverButton = Button(constants.root, text = "Clever", command = lambda: openWebsite("https://clever.com/")) 
